...
import { clearNodesLocal } from "@/lib/strategyweb/nodeStore";
import { clearActivePlanId, deletePlan } from "@/lib/strategyweb/planStore";
import { clearTasksLocal } from "@/lib/strategyweb/taskStore";

export const ONBOARDING_DRAFT_KEY = "visr-onboarding-draft-v3";
