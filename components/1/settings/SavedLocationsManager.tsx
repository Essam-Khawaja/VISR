...
import { SavedLocation, LocationType, LOCATION_TYPES } from "@/lib/1/types";
...
export default function SavedLocationsManager() {
  ...
  async function submit(e: React.FormEvent) {
    ...
    if (editingId) {
      await fetch("/api/1/saved-locations", {
        method: "PATCH",
  ...
  async function deleteLocation(id: string) {
    ...
    await fetch(`/api/1/saved-locations?id=${id}`, { method: "DELETE" });
    await load();
  }
