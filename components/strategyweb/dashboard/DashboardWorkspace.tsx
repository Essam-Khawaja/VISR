...
import { getRootNode } from "@/components/strategyweb/graph/universityGraphLayout";
import type { SemesterProgress } from "@/lib/strategyweb/taskStore";
import type {
  CutRecommendation,
  Priority,
  RouteStatus,
...
export function DashboardWorkspace() {
  ...
  return (
    <div className="flex-1 overflow-y-auto">
      <div className="mx-auto flex w-full max-w-[1500px] flex-col gap-5 px-4 pb-12 pt-5 sm:px-6 sm:pb-16 lg:px-8 lg:pb-20 lg:pt-7">
        {/* Overview map card */}
        <div className="group relative w-full overflow-hidden rounded-2xl border border-border bg-base shadow-card transition-shadow hover:shadow-lift">
          <div className="pointer-events-none relative z-0 h-[480px] sm:h-[640px] lg:h-[800px]">
...
function InsightsContent({
  ...
  return (
    <div className="mx-auto flex w-full max-w-[1500px] flex-col gap-5 px-4 pb-10 pt-5 sm:px-6 sm:pb-12 lg:px-8 lg:pb-16 lg:pt-7">
      <TopBand
        plan={plan}
        displayDestination={displayDestination}
        isDemo={isDemo}
    ...
    <Card noHover className="overflow-hidden p-0">
      <div className="grid gap-0 lg:grid-cols-[1fr_260px]">
        ...
        <div className="border-t border-border bg-elevated/70 p-5 lg:border-l lg:border-t-0 lg:p-6">
          ...
          <Link href="/flowgram" className="mt-4 block">
