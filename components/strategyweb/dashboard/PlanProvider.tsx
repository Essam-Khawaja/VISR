...
import {
  ...
  type ActionState,
  type StoredPlan,
} from "@/lib/strategyweb/planStore";
import {
  createStrategyNode,
  ...
  updateStrategyNode,
} from "@/lib/strategyweb/nodeStore";
import {
  computeNodeRollup,
...
import { DEMO_PLAN_ID, fixturePlan } from "@/lib/strategyweb/fixture";
import {
  filterUniversitySubtree,
  hasUniversityNodes,
} from "@/components/strategyweb/graph/universityGraphLayout";
import type {
  OpportunityCheck,
  StrategyNode,
  StrategyPlan,
