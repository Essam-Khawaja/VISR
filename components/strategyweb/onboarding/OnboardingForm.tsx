...
import { Input } from "@/components/strategyweb/ui/Input";
...
import type { AcademicTerm } from "@/lib/strategyweb/types";
import { addLocalDays, todayLocalDate } from "@/lib/strategyweb/taskStore";
import {
  applyMapDelta,
  currentSemesterId,
} from "./applyMapDelta";
...
export function OnboardingForm({
  ...
  return (
    <div className="flex w-full flex-col gap-3">
      ...
      <Card noHover className="flex max-h-[calc(100dvh-7rem)] flex-col bg-surface/90 shadow-lift backdrop-blur-xl">
        <div className="-mx-5 -mt-5 flex flex-col overflow-hidden rounded-t-3xl sm:-mx-6 sm:-mt-6">
          <div className="flex-1 overflow-y-auto px-5 pb-3 pt-5 sm:px-6 sm:pt-6">
        ...
        <div className="-mx-5 -mb-5 mt-3 flex items-center justify-between gap-2 border-t border-border/60 px-4 py-3 sm:-mx-6 sm:-mb-6">
          {currentStep > 0 ? (
  ...
  return (
    <div className="flex flex-col gap-4">
      <SectionIntro
        ...
        body="VISR will split the year into semesters and place recurring commitments where they belong."
      />
    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="grid grid-cols-[1fr_auto] gap-2">
        <DatePicker
          ...
          onChange={(next) => setTaskDraft({ ...taskDraft, dueDate: next })}
  ...
  return (
    <div className="flex flex-col gap-4">
      <SectionIntro
        ...
        body="This becomes the first bottleneck VISR tracks on the dashboard."
      />
      <textarea
