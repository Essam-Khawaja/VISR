  ...
  return (
    ...
    >
      <form
        ...
        className="relative w-full sm:max-w-lg bg-white rounded-3xl border border-stone-200 shadow-2xl flex flex-col max-h-[90dvh] sm:max-h-[92dvh] overflow-hidden"
      >
        <div className="flex items-center justify-between px-5 py-3.5 border-b border-stone-200/60 shrink-0">
          <h2 className="text-base font-semibold tracking-tight text-amaranth">
        ...
        <div className="flex-1 min-h-0 overflow-y-auto px-5 py-4 space-y-4 bg-white">
          <div>
        ...
        <div className="flex items-center justify-between gap-2 px-5 py-3.5 border-t border-stone-200/60 shrink-0">
          {event && onDelete ? (
            <button
              type="button"
