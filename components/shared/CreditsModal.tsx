...
export function CreditsModal({ open, onClose }: CreditsModalProps) {
  ...
  return createPortal(
    ...
    >
      ...
      <div
        className="relative w-full max-w-xl overflow-hidden rounded-3xl border border-border bg-surface shadow-lift"
      ...
      >
        <div className="flex items-center justify-between border-b border-border px-6 py-4">
          ...
          <button
            type="button"
            onClick={onClose}
            className="-mr-1.5 rounded-full p-2 text-tertiary transition-colors hover:bg-elevated hover:text-primary"
