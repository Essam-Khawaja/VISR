...
export const DEFAULT_CATEGORY_ITEMS: Partial<Record<EventCategory, string[]>> =
  {
    class: ["Laptop", "Notebook", "Charger"],
    meeting: ["Laptop", "Notebook"],
    gym: ["Gym clothes", "Water bottle", "Protein powder"],
    grocery: ["Grocery bag", "Grocery list"],
    assignment: ["Laptop", "Charger"],
    project: ["Laptop", "Charger"],
  };
