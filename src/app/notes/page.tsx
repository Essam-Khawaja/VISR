...
export default function NotesPage() {
  ...
  const sorted = [...events].sort((a, b) => {
    const aCompleted = a.note_status === "completed";
    const bCompleted = b.note_status === "completed";
              ...
              return (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p
                      className={`text-sm text-stone-700 mt-2 leading-relaxed ${
                        ...
                        <button
                          ...
                          className={`text-[11px] px-2 py-0.5 rounded-full border font-medium transition disabled:opacity-50 ${
                            event.note_status === s
                              ...
                              : "bg-white/70 border-stone-200 text-stone-600 hover:border-stone-400"
                          }`}
                        >
                          {s.replace("_", " ")}
                        </button>
